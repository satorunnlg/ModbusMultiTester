	...
	public partial class MainForm : Form
	{
		...
		private void AddMonitorWindow()
		{
			...
			child.DataEdited += (addr, val) =>
			{
				...
				{
					// 蜷梧悄逧・↓譖ｸ縺崎ｾｼ縺ｿ繧貞ｮ溯｡鯉ｼ域嶌縺崎ｾｼ縺ｿ螳御ｺ・ｒ遒ｺ螳溘↓縺吶ｋ・・
					try
					{
						...
						switch (typeIdx)
						{
							...
							case 3: // Holding Register (Write Single Register 0x06)
								...
								break;
							default:
								// Input(1x), InputReg(3x) 縺ｯ隱ｭ縺ｿ蜿悶ｊ蟆ら畑
					...
					catch (Exception ex)
					{
						...
						MessageBox.Show($"譖ｸ縺崎ｾｼ縺ｿ繧ｨ繝ｩ繝ｼ: {ex.Message}", "繧ｨ繝ｩ繝ｼ", MessageBoxButtons.OK, MessageBoxIcon.Error);
					}
				}
			};
			...
			if (radioButtonMaster.Checked)
			{
				...
				try
				{
					...
					foreach (var monitor in monitors)
					{
						...
						// 繝槭せ繧ｿ繝ｼ繝｢繝ｼ繝峨〒繧らｷｨ髮・庄閭ｽ縺ｫ縺吶ｋ・医Ξ繧ｸ繧ｹ繧ｿ繧ｿ繧､繝励↓蠢懊§縺ｦ・・
